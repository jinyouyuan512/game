          ...
          <div class="comment-content">
            ...
            <div class="comment-actions">
              <el-button type="text" size="small" @click="toggleCommentLike(comment.id)">
                <el-icon v-if="!comment.is_liked"><ThumbsUp /></el-icon>
                <el-icon v-else><ThumbsUpFilled /></el-icon>
                {{ comment.like_count }}
              </el-button>
...
import { ThumbsUp, ThumbsUpFilled, ChatDotRound, Share } from '@element-plus/icons-vue'
...
// 计算属性
const likeIcon = computed(() => isLiked.value ? ThumbsUpFilled : ThumbsUp)
